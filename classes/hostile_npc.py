...
class HostileNpc:
    ...
    def chase(self):
        ...
        collides = circle_collision(updated_position[0], updated_position[1], self.skin.height / 2, player_position[0] + 152, player_position[1] + 152, player_scaled.height / 2)
    ...
    def render(self):
        self.chase()
        pygame.draw.aacircle(display, (255, 0, 0), (self.position[0] + self.skin.width / 2 - player_position[0], self.position[1] + self.skin.height / 2 - player_position[1]), self.skin.height / 2, 1)
        pygame.draw.aacircle(display, (0, 0, 255), (player_position[0] + 160 - player_position[0], player_position[1] + 160 - player_position[1]), player_scaled.height / 2, 1)
